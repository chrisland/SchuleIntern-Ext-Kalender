<template>
    <div class="si-calendar ">
      ...
      <div class="si-calendar-header">
          <button class="si-btn chevron-left" @click="prevMonth">
          ...
          <div class="title">{{openMonth| moment("MMMM YYYY")}}</div>
          <button class="si-btn chevron-right" @click="nextMonth">
            <i class="fa fa-arrow-right"></i> Weiter
          </button>
      </div>

      <table class="si-table si-table-style-firstFix si-table-style-allLeft">
        <thead>
          <tr>
            <td class="labelKW"></td>
